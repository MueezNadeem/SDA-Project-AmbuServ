...
public class DispatcherViewTasks extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dispatcher_view_tasks);

        TaskList=DB.GetAllTasks();
        LV=(ListView) findViewById(R.id.listAvailTask);
